                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="{{ url('uploads') }}/{{ $product->image }}"
                                alt="">
                        </div>
                    </div>
                </div>
...
data-url="{{ route('login') }}"
                     @else
                        ...
                        <ul>
                            ...
                            <li><b>Vận chuyển</b>
                                @guest
                                    <span><a class="text-success" style="text-decoration:underline"
                                            href="{{ route('login') }}">Đăng nhập để biết chính sách vận chuyển</a></span>
                                @else
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab"
                                    aria-selected="false">Đánh giá <span
                                        id="vote-count">({{ $product->votes()->get()->count() }})</span></a>
                            </li>
                        </ul>
...
value="0"
                                       @else
                                          value="{{ $yourVote }}" @endguest>
                                                <input id="input-product" type="hidden" name="product"
                                                    value="{{ $product->id }}">
                                                <div class="form-group">
                                                    <div class="row">
                                    ...
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg"
                                            ...
                                            <ul class="product__item__pic__hover">
                                                ...
                                                <li><a href="{{ route('home.show', $item->id) }}"><i
